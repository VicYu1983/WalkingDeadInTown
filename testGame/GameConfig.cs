...
class GameConfig
{
    ...
    public static List<object[]> WeaponConfig = new List<object[]>()
    {
        ...
        new object[] { "步槍(半自動)", 10, .6f, false, 1, 30.0f, 0.5f, false, 0.0f, false, false, 5, false, false },
        ...
        new object[] { "砍刀:半自動", 10, 1.0f, false, 1, 0.0f, 0.03f, false, .7f, true, false, 0, true, true },
        ...
        new object[] { "步槍:全自動", 6, .6f, false, 1, 30.0f, 0.2f, false, 0.0f, false, true, 0, false, false }
    };
}