...
class GameConfig
{
    ...
    public static List<object[]> WeaponConfig = new List<object[]>()
    {
        ...
        new object[] { "步槍(半自動)", 10, .3f, false, 1, 30.0f, 0.05f, false, 0.0f, false, false, 5, true },
        new object[] { "高性能狙擊槍", 60, 1.0f, false, 1, 0.0f, 0.1f, false, 1.0f, true, false, 0, false },
        new object[] { "雙管散彈槍", 6, .2f, false, 10, 20.0f, 1.0f, false, 0.0f, false, false, 0, false },
        new object[] { "智慧型狙擊槍", 300, 1.0f, true, 1, 0.0f, 0.02f, true, .5f, true, false, 0, true },
